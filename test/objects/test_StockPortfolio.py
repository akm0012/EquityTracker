...
class TestStockGrant(TestCase):
    ...
    def test_get_max_grant_count_0(self):
        stock_grant_1 = StockGrant("mfst", 0, 0)
        stock_grant_2 = StockGrant("qppl", 0, 0)
        stock_grant_3 = StockGrant("qppl", 0, 0)
    ...
    def test_get_max_grant_count_1(self):
        stock_grant_1 = StockGrant("mfst", 1, 1)
        stock_grant_2 = StockGrant("qppl", 0, 0)
        stock_grant_3 = StockGrant("qppl", 0, 0)
    ...
    def test_get_max_grant_count_2(self):
        stock_grant_1 = StockGrant("mfst", 0, 0)
        stock_grant_2 = StockGrant("qppl", 1, 1)
        stock_grant_3 = StockGrant("qppl", 2, 2)
